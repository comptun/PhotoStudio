...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@@Z DD imagerel $LN302@FloodFill4
	DD	imagerel $LN302@FloodFill4+1393
...
;	COMDAT xdata
xdata	SEGMENT
$ip2state$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@@Z DQ 00741046e0204490ar ; 9.83025e-274
	DD	0405e106H
	DW	02b1H
	DB	00H
xdata	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@@Z DQ 0000e982f00133d19r ; 2.02961e-308
	DQ	000107825000f882ar		; 2.29034e-308
	DQ	0002c341d00116821r		; 7.84438e-308
