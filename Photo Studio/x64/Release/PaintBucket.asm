...
?m_Color@WindowData@@2U?$vec@$03M$0A@@glm@@A DD 000000000r ; 0 ; WindowData::m_Color
	...
	DD	03f800000r			; 1
_DATA	ENDS
;	COMDAT ?dx@?1??FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z@4QBHB
CONST	SEGMENT
?dx@?1??FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z@4QBHB DD 00H ; `PaintBucket::FloodFill4Stack'::`2'::dx
	DD	01H
	DD	00H
	DD	0ffffffffH
CONST	ENDS
;	COMDAT ?PreviousPosition@?1??FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z@4U67@A
_DATA	SEGMENT
?PreviousPosition@?1??FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z@4U67@A DD 0bf800000r ; -1 ; `PaintBucket::FloodFill4Stack'::`2'::PreviousPosition
	DD	0bf800000r			; -1
	DD	0bf800000r			; -1
_DATA	ENDS
;	COMDAT ?dy@?1??FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z@4QBHB
CONST	SEGMENT
?dy@?1??FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z@4QBHB DD 0ffffffffH ; `PaintBucket::FloodFill4Stack'::`2'::dy
	DD	00H
	DD	01H
	DD	00H
...
PUBLIC	?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z ; PaintBucket::FloodFill4Stack
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z DD imagerel $LN302@FloodFill4
	DD	imagerel $LN302@FloodFill4+1361
	DD	imagerel $unwind$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$ip2state$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z DQ 0074904700203e50ar ; 1.44516e-273
	DD	0405d506H
	DW	02a9H
	DB	00H
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$stateUnwindMap$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z DW 0c06H
...
;	COMDAT xdata
xdata	SEGMENT
$cppxdata$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z DB 028H
	DD	imagerel $stateUnwindMap$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z
	DD	imagerel $ip2state$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z DQ 0000e882a00113819r ; 2.02091e-308
	DQ	000106821000f7825r		; 2.28164e-308
	DQ	00022011d002a341dr		; 5.00763e-308
	DQ	0c00cd00ee010f012r		; -3.60159
	DQ	0000050086009700ar		; 4.34762e-310
	DD	imagerel __GSHandlerCheck_EH4
	DD	imagerel $cppxdata$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@U?$vec@$02M$0A@@glm@@@Z
	DD	0d2H
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
