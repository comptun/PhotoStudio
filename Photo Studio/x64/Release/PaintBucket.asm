...
$pdata$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@@Z DD imagerel $LN302@FloodFill4
	DD	imagerel $LN302@FloodFill4+1382
...
;	COMDAT xdata
xdata	SEGMENT
$ip2state$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@@Z DQ 00715045e0204ad0ar ; 1.5176e-274
	DD	0405a506H
	DW	02a9H
	DB	00H
xdata	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?FloodFill4Stack@PaintBucket@@QEAAXV?$shared_ptr@VLayer@@@std@@AEAVPixelBuffer@@@Z DQ 0000f982f00133d19r ; 2.16868e-308
	DQ	0001178250010882ar		; 2.42941e-308
	DQ	0002e341d00126821r		; 8.40065e-308
