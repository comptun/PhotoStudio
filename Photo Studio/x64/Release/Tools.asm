...
$pdata$?ToolButton@Tools@@AEAAXW4Tool@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@1@Z DD imagerel $LN191@ToolButton
	DD	imagerel $LN191@ToolButton+870
	DD	imagerel $unwind$?ToolButton@Tools@@AEAAXW4Tool@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@1@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?DrawToolbar@Tools@@QEAAXXZ DD imagerel $LN1867@DrawToolba
	DD	imagerel $LN1867@DrawToolba+1226
	DD	imagerel $unwind$?DrawToolbar@Tools@@QEAAXXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?DrawToolPropertiesMenu@Tools@@QEAAXXZ DD imagerel $LN52@DrawToolPr
	DD	imagerel $LN52@DrawToolPr+776
	DD	imagerel $unwind$?DrawToolPropertiesMenu@Tools@@QEAAXXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$??0Tools@@QEAA@XZ DD imagerel $LN17@Tools
	DD	imagerel $LN17@Tools+98
...
;	COMDAT xdata
xdata	SEGMENT
$ip2state$?DrawToolbar@Tools@@QEAAXXZ DQ 0003602029d00da3ar ; 1.22423e-307
	DQ	0004a08640028044ar		; 2.89624e-307
	DQ	00028084a0036023er		; 6.68423e-308
	DQ	00036023e004a0864r		; 1.22428e-307
	DQ	0004a08640028084ar		; 2.89624e-307
	DQ	00028084a0036023er		; 6.68423e-308
	DQ	00036023e004a0864r		; 1.22428e-307
	DD	028084aH
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$stateUnwindMap$?DrawToolbar@Tools@@QEAAXXZ DW 0e0aH
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?DrawToolbar@Tools@@QEAAXXZ DQ 00015741a00081a11r ; 2.98348e-308
...
;	COMDAT xdata
xdata	SEGMENT
$ip2state$?ToolButton@Tools@@AEAAXW4Tool@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@1@Z DQ 002790208f504d006r ; 9.55966e-297
	DB	00H
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
