...
$pdata$?ToolButton@Tools@@AEAAXW4Tool@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@1@Z DD imagerel $LN184@ToolButton
	DD	imagerel $LN184@ToolButton+870
...
;	COMDAT xdata
xdata	SEGMENT
$ip2state$?DrawToolbar@Tools@@QEAAXXZ DQ 000220202f100ca26r ; 5.0086e-308
