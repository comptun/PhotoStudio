...
;	COMDAT pdata
pdata	SEGMENT
$pdata$??0Layer@@QEAA@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_K11U?$vec@$03M$0A@@glm@@@Z DD imagerel $LN46@Layer
	DD	imagerel $LN46@Layer+314
	DD	imagerel $unwind$??0Layer@@QEAA@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_K11U?$vec@$03M$0A@@glm@@@Z
;	COMDAT xdata
xdata	SEGMENT
$ip2state$??0Layer@@QEAA@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_K11U?$vec@$03M$0A@@glm@@@Z DD 042029006H
	DW	0c004H
	DB	00H
xdata	ENDS
;	COMDAT xdata
